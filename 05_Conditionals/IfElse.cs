...
namespace _05_Conditionals
{
    ...
    public class IfElse
    {
        ...
        public void IfStatements()
        {
            ...
            if (userIsHungry) //can put bool variables without any other conditions. Can't do that with others
            {
                Console.WriteLine("Eat Something!");
            }

            int houseSpendStudying = 16;
            if (houseSpendStudying < 15)
            {
